...
var domain_domain_pb = require("../domain/domain_pb");
...
LocatorService.PipelineLifecycleEventStream = {
  methodName: "PipelineLifecycleEventStream",
  service: LocatorService,
  requestStream: false,
  responseStream: true,
  requestType: locator_service_pb.PipelineLifecycleEventStreamRequest,
  responseType: domain_domain_pb.SystemEvent.PipelineEvent
};
...
LocatorServiceClient.prototype.pipelineLifecycleEventStream = function pipelineLifecycleEventStream(requestMessage, metadata) {
  var listeners = {
    data: [],
    end: [],
    status: []
  };
  var client = grpc.invoke(LocatorService.PipelineLifecycleEventStream, {
    request: requestMessage,
    host: this.serviceHost,
    metadata: metadata,
    transport: this.options.transport,
