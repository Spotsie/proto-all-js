...
/**
 * repeated domain.Observation observations = 1;
...
proto.locator.ObservationStreamMessage.prototype.getObservationsList = function() {
  return /** @type{!Array<!proto.domain.Observation>} */ (
    jspb.Message.getRepeatedWrapperField(this, domain_domain_pb.Observation, 1));
};
...
proto.locator.ObservationStreamMessage.prototype.addObservations = function(opt_value, opt_index) {
  return jspb.Message.addToRepeatedWrapperField(this, 1, opt_value, proto.domain.Observation, opt_index);
};
