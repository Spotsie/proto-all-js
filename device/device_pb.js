...
proto.device.Session.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    test: jspb.Message.getFieldWithDefault(msg, 4, 0)
  };
...
/**
 * optional int64 test = 4;
 * @return {number}
 */
proto.device.Session.prototype.getTest = function() {
 ...
 * @return {!proto.device.Session} returns this
 */
proto.device.Session.prototype.setTest = function(value) {
