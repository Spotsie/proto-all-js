...
export namespace ClientMessage {
  ...
  export class Discovery extends jspb.Message {
    ...
    setSoftwareId(value: number): void;
...
export namespace BackendMessage {
  ...
  export class Configure extends jspb.Message {
    clearGatewayFeaturesList(): void;
    getGatewayFeaturesList(): Array<GatewayFeature>;
    setGatewayFeaturesList(value: Array<GatewayFeature>): void;
    addGatewayFeatures(value?: GatewayFeature, index?: number): GatewayFeature;
  ...
  export namespace Configure {
    export type AsObject = {
      gatewayFeaturesList: Array<GatewayFeature.AsObject>,
    }
  }
