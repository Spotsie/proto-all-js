...
export class BeaconLocationUpdateEvent extends jspb.Message {
  hasBeacon(): boolean;
  clearBeacon(): void;
  getBeacon(): domain_domain_pb.Beacon | undefined;
  setBeacon(value?: domain_domain_pb.Beacon): void;
  ...
  serializeBinary(): Uint8Array;
  toObject(includeInstance?: boolean): BeaconLocationUpdateEvent.AsObject;
  static toObject(includeInstance: boolean, msg: BeaconLocationUpdateEvent): BeaconLocationUpdateEvent.AsObject;
  static extensions: {[key: number]: jspb.ExtensionFieldInfo<jspb.Message>};
  static extensionsBinary: {[key: number]: jspb.ExtensionFieldBinaryInfo<jspb.Message>};
  static serializeBinaryToWriter(message: BeaconLocationUpdateEvent, writer: jspb.BinaryWriter): void;
  static deserializeBinary(bytes: Uint8Array): BeaconLocationUpdateEvent;
  static deserializeBinaryFromReader(message: BeaconLocationUpdateEvent, reader: jspb.BinaryReader): BeaconLocationUpdateEvent;
}

export namespace BeaconLocationUpdateEvent {
  export type AsObject = {
    beacon?: domain_domain_pb.Beacon.AsObject,
