...
goog.exportSymbol('proto.event.BeaconLocationUpdateEvent', null, global);
 ...
 * @constructor
 */
proto.event.BeaconLocationUpdateEvent = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.event.BeaconLocationUpdateEvent, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.event.BeaconLocationUpdateEvent.displayName = 'proto.event.BeaconLocationUpdateEvent';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @return {!Object}
 */
proto.event.BeaconLocationUpdateEvent.prototype.toObject = function(opt_includeInstance) {
  return proto.event.BeaconLocationUpdateEvent.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.event.BeaconLocationUpdateEvent} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.event.BeaconLocationUpdateEvent.toObject = function(includeInstance, msg) {
  var f, obj = {
    beacon: (f = msg.getBeacon()) && domain_domain_pb.Beacon.toObject(includeInstance, f),
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.event.BeaconLocationUpdateEvent}
 */
proto.event.BeaconLocationUpdateEvent.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.event.BeaconLocationUpdateEvent;
  return proto.event.BeaconLocationUpdateEvent.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.event.BeaconLocationUpdateEvent} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.event.BeaconLocationUpdateEvent}
 */
proto.event.BeaconLocationUpdateEvent.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.event.BeaconLocationUpdateEvent.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.event.BeaconLocationUpdateEvent.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.event.BeaconLocationUpdateEvent} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.event.BeaconLocationUpdateEvent.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getBeacon();
  if (f != null) {
    writer.writeMessage(
 ...
 * @return {?proto.domain.Beacon}
 */
proto.event.BeaconLocationUpdateEvent.prototype.getBeacon = function() {
  return /** @type{?proto.domain.Beacon} */ (
...
/**
 * @param {?proto.domain.Beacon|undefined} value
 * @return {!proto.event.BeaconLocationUpdateEvent} returns this
*/
proto.event.BeaconLocationUpdateEvent.prototype.setBeacon = function(value) {
  return jspb.Message.setWrapperField(this, 1, value);
};
 ...
 * @return {!proto.event.BeaconLocationUpdateEvent} returns this
 */
proto.event.BeaconLocationUpdateEvent.prototype.clearBeacon = function() {
  return this.setBeacon(undefined);
};
 ...
 * @return {boolean}
 */
proto.event.BeaconLocationUpdateEvent.prototype.hasBeacon = function() {
  return jspb.Message.getField(this, 1) != null;
};
 ...
 */
proto.event.BeaconLocationUpdateEvent.prototype.getTime = function() {
 ...
 * @return {!proto.event.BeaconLocationUpdateEvent} returns this
*/
proto.event.BeaconLocationUpdateEvent.prototype.setTime = function(value) {
  return jspb.Message.setWrapperField(this, 2, value);
};
 ...
 * @return {!proto.event.BeaconLocationUpdateEvent} returns this
 */
proto.event.BeaconLocationUpdateEvent.prototype.clearTime = function() {
 ...
 * @return {boolean}
 */
proto.event.BeaconLocationUpdateEvent.prototype.hasTime = function() {
  return jspb.Message.getField(this, 2) != null;
};
 ...
 * @return {number}
 */
proto.event.BeaconLocationUpdateEvent.prototype.getLocationId = function() {
 ...
 * @return {!proto.event.BeaconLocationUpdateEvent} returns this
 */
proto.event.BeaconLocationUpdateEvent.prototype.setLocationId = function(value) {
