...
type LocationApiGetGeoLocationHistory = {
  readonly methodName: string;
  readonly service: typeof LocationApi;
  readonly requestStream: false;
  readonly responseStream: false;
  readonly requestType: typeof location_service_pb.GetGeoLocationHistoryRequest;
  readonly responseType: typeof location_service_pb.GetGeoLocationHistoryResponse;
};
...
export class LocationApi {
  ...
  static readonly GetGeoLocationHistory: LocationApiGetGeoLocationHistory;
...
export class LocationApiClient {
  ...
  getGeoLocationHistory(
    requestMessage: location_service_pb.GetGeoLocationHistoryRequest,
    metadata: grpc.Metadata,
    callback: (error: ServiceError|null, responseMessage: location_service_pb.GetGeoLocationHistoryResponse|null) => void
  ): UnaryResponse;
  getGeoLocationHistory(
    requestMessage: location_service_pb.GetGeoLocationHistoryRequest,
    callback: (error: ServiceError|null, responseMessage: location_service_pb.GetGeoLocationHistoryResponse|null) => void
