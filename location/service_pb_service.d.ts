...
type LocationApiGetSubjectLocationsAt = {
  readonly methodName: string;
  readonly service: typeof LocationApi;
  readonly requestStream: false;
  readonly responseStream: false;
  readonly requestType: typeof location_service_pb.GetSubjectLocationsAtRequest;
  readonly responseType: typeof location_service_pb.GetSubjectLocationsAtResponse;
};

type LocationApiGetLatestSubjectPosition = {
  readonly methodName: string;
  readonly service: typeof LocationApi;
  readonly requestStream: false;
  readonly responseStream: false;
  readonly requestType: typeof location_service_pb.GetLatestSubjectPositionRequest;
  readonly responseType: typeof location_service_pb.GetLatestSubjectPositionResponse;
};
...
export class LocationApi {
  ...
  static readonly GetSubjectLocationsAt: LocationApiGetSubjectLocationsAt;
  static readonly GetLatestSubjectPosition: LocationApiGetLatestSubjectPosition;
}
...
export class LocationApiClient {
  ...
  getSubjectLocationsAt(
    requestMessage: location_service_pb.GetSubjectLocationsAtRequest,
    metadata: grpc.Metadata,
    callback: (error: ServiceError|null, responseMessage: location_service_pb.GetSubjectLocationsAtResponse|null) => void
  ): UnaryResponse;
  getSubjectLocationsAt(
    requestMessage: location_service_pb.GetSubjectLocationsAtRequest,
    callback: (error: ServiceError|null, responseMessage: location_service_pb.GetSubjectLocationsAtResponse|null) => void
  ...
  getLatestSubjectPosition(
    requestMessage: location_service_pb.GetLatestSubjectPositionRequest,
    metadata: grpc.Metadata,
    callback: (error: ServiceError|null, responseMessage: location_service_pb.GetLatestSubjectPositionResponse|null) => void
  ): UnaryResponse;
  getLatestSubjectPosition(
    requestMessage: location_service_pb.GetLatestSubjectPositionRequest,
    callback: (error: ServiceError|null, responseMessage: location_service_pb.GetLatestSubjectPositionResponse|null) => void
