...
LocationApi.GetGeoLocationHistory = {
  methodName: "GetGeoLocationHistory",
  service: LocationApi,
  requestStream: false,
  responseStream: false,
  requestType: location_service_pb.GetGeoLocationHistoryRequest,
  responseType: location_service_pb.GetGeoLocationHistoryResponse
};
...
LocationApiClient.prototype.getGeoLocationHistory = function getGeoLocationHistory(requestMessage, metadata, callback) {
  if (arguments.length === 2) {
    callback = arguments[1];
  }
  var client = grpc.unary(LocationApi.GetGeoLocationHistory, {
    request: requestMessage,
    host: this.serviceHost,
    metadata: metadata,
    transport: this.options.transport,
