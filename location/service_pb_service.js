...
LocationApi.GetLatestSubjectPosition = {
  methodName: "GetLatestSubjectPosition",
  service: LocationApi,
  requestStream: false,
  responseStream: false,
  requestType: location_service_pb.GetLatestSubjectPositionRequest,
  responseType: location_service_pb.GetLatestSubjectPositionResponse
};
...
LocationApiClient.prototype.getLatestSubjectPosition = function getLatestSubjectPosition(requestMessage, metadata, callback) {
  if (arguments.length === 2) {
    callback = arguments[1];
  }
  var client = grpc.unary(LocationApi.GetLatestSubjectPosition, {
    request: requestMessage,
    host: this.serviceHost,
    metadata: metadata,
    transport: this.options.transport,
