...
goog.exportSymbol('proto.location.GetLatestSubjectPositionRequest', null, global);
goog.exportSymbol('proto.location.GetLatestSubjectPositionResponse', null, global);
 ...
 * @constructor
 */
proto.location.GetLatestSubjectPositionRequest = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.location.GetLatestSubjectPositionRequest, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.location.GetLatestSubjectPositionRequest.displayName = 'proto.location.GetLatestSubjectPositionRequest';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @constructor
 */
proto.location.GetLatestSubjectPositionResponse = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.location.GetLatestSubjectPositionResponse, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.location.GetLatestSubjectPositionResponse.displayName = 'proto.location.GetLatestSubjectPositionResponse';
}
...
proto.location.GetRealtimeLocationResponse.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    point: (f = msg.getPoint()) && domain_domain_pb.GeoPoint.toObject(includeInstance, f)
  };
...
proto.location.GetRealtimeLocationResponse.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 3:
      ...
      break;
    case 4:
      var value = new domain_domain_pb.GeoPoint;
      reader.readMessage(value,domain_domain_pb.GeoPoint.deserializeBinaryFromReader);
      msg.setPoint(value);
      break;
    default:
      reader.skipField();
...
proto.location.GetRealtimeLocationResponse.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f != null) {
    writer.writeMessage(
      4,
      f,
      domain_domain_pb.GeoPoint.serializeBinaryToWriter
    );
  }
};
...
/**
 * optional domain.GeoPoint point = 4;
 * @return {?proto.domain.GeoPoint}
 */
proto.location.GetRealtimeLocationResponse.prototype.getPoint = function() {
  return /** @type{?proto.domain.GeoPoint} */ (
    jspb.Message.getWrapperField(this, domain_domain_pb.GeoPoint, 4));
};


/**
 * @param {?proto.domain.GeoPoint|undefined} value
 * @return {!proto.location.GetRealtimeLocationResponse} returns this
*/
proto.location.GetRealtimeLocationResponse.prototype.setPoint = function(value) {
 ...
 * @return {!proto.location.GetRealtimeLocationResponse} returns this
 */
proto.location.GetRealtimeLocationResponse.prototype.clearPoint = function() {
 ...
 * @return {boolean}
 */
proto.location.GetRealtimeLocationResponse.prototype.hasPoint = function() {
 ...
 * @return {!Object}
 */
proto.location.GetLatestSubjectPositionRequest.prototype.toObject = function(opt_includeInstance) {
  return proto.location.GetLatestSubjectPositionRequest.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.location.GetLatestSubjectPositionRequest} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.location.GetLatestSubjectPositionRequest.toObject = function(includeInstance, msg) {
  var f, obj = {
    subject: (f = msg.getSubject()) && domain_domain_pb.Subject.toObject(includeInstance, f)
  };
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.location.GetLatestSubjectPositionRequest}
 */
proto.location.GetLatestSubjectPositionRequest.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.location.GetLatestSubjectPositionRequest;
  return proto.location.GetLatestSubjectPositionRequest.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.location.GetLatestSubjectPositionRequest} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.location.GetLatestSubjectPositionRequest}
 */
proto.location.GetLatestSubjectPositionRequest.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.location.GetLatestSubjectPositionRequest.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.location.GetLatestSubjectPositionRequest.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.location.GetLatestSubjectPositionRequest} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.location.GetLatestSubjectPositionRequest.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getSubject();
  if (f != null) {
    writer.writeMessage(
 ...
 * @return {?proto.domain.Subject}
 */
proto.location.GetLatestSubjectPositionRequest.prototype.getSubject = function() {
  return /** @type{?proto.domain.Subject} */ (
    jspb.Message.getWrapperField(this, domain_domain_pb.Subject, 1));
};
...
/**
 * @param {?proto.domain.Subject|undefined} value
 * @return {!proto.location.GetLatestSubjectPositionRequest} returns this
*/
proto.location.GetLatestSubjectPositionRequest.prototype.setSubject = function(value) {
  return jspb.Message.setWrapperField(this, 1, value);
};
 ...
 * @return {!proto.location.GetLatestSubjectPositionRequest} returns this
 */
proto.location.GetLatestSubjectPositionRequest.prototype.clearSubject = function() {
  return this.setSubject(undefined);
};
 ...
 * @return {boolean}
 */
proto.location.GetLatestSubjectPositionRequest.prototype.hasSubject = function() {
  return jspb.Message.getField(this, 1) != null;
};
 ...
 * @return {!Object}
 */
proto.location.GetLatestSubjectPositionResponse.prototype.toObject = function(opt_includeInstance) {
  return proto.location.GetLatestSubjectPositionResponse.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.location.GetLatestSubjectPositionResponse} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.location.GetLatestSubjectPositionResponse.toObject = function(includeInstance, msg) {
  var f, obj = {
    time: (f = msg.getTime()) && google_protobuf_timestamp_pb.Timestamp.toObject(includeInstance, f),
    point: (f = msg.getPoint()) && domain_domain_pb.GeoPoint.toObject(includeInstance, f)
  };
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.location.GetLatestSubjectPositionResponse}
 */
proto.location.GetLatestSubjectPositionResponse.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.location.GetLatestSubjectPositionResponse;
  return proto.location.GetLatestSubjectPositionResponse.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.location.GetLatestSubjectPositionResponse} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.location.GetLatestSubjectPositionResponse}
 */
proto.location.GetLatestSubjectPositionResponse.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.location.GetLatestSubjectPositionResponse.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.location.GetLatestSubjectPositionResponse.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.location.GetLatestSubjectPositionResponse} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.location.GetLatestSubjectPositionResponse.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getTime();
  if (f != null) {
    writer.writeMessage(
 ...
 * @return {?proto.google.protobuf.Timestamp}
 */
proto.location.GetLatestSubjectPositionResponse.prototype.getTime = function() {
  return /** @type{?proto.google.protobuf.Timestamp} */ (
    jspb.Message.getWrapperField(this, google_protobuf_timestamp_pb.Timestamp, 1));
};
...
/**
 * @param {?proto.google.protobuf.Timestamp|undefined} value
 * @return {!proto.location.GetLatestSubjectPositionResponse} returns this
*/
proto.location.GetLatestSubjectPositionResponse.prototype.setTime = function(value) {
  return jspb.Message.setWrapperField(this, 1, value);
};
 ...
 * @return {!proto.location.GetLatestSubjectPositionResponse} returns this
 */
proto.location.GetLatestSubjectPositionResponse.prototype.clearTime = function() {
  return this.setTime(undefined);
};
 ...
 * @return {boolean}
 */
proto.location.GetLatestSubjectPositionResponse.prototype.hasTime = function() {
  return jspb.Message.getField(this, 1) != null;
};


/**
 * optional domain.GeoPoint point = 2;
 * @return {?proto.domain.GeoPoint}
 */
proto.location.GetLatestSubjectPositionResponse.prototype.getPoint = function() {
  return /** @type{?proto.domain.GeoPoint} */ (
    jspb.Message.getWrapperField(this, domain_domain_pb.GeoPoint, 2));
};
 ...
 * @return {!proto.location.GetLatestSubjectPositionResponse} returns this
*/
proto.location.GetLatestSubjectPositionResponse.prototype.setPoint = function(value) {
  return jspb.Message.setWrapperField(this, 2, value);
};
 ...
 * @return {!proto.location.GetLatestSubjectPositionResponse} returns this
 */
proto.location.GetLatestSubjectPositionResponse.prototype.clearPoint = function() {
  return this.setPoint(undefined);
};
 ...
 * @return {boolean}
 */
proto.location.GetLatestSubjectPositionResponse.prototype.hasPoint = function() {
  return jspb.Message.getField(this, 2) != null;
};
