...
type DeploymentApiGetZone = {
  readonly methodName: string;
  readonly service: typeof DeploymentApi;
  readonly requestStream: false;
  readonly responseStream: false;
  readonly requestType: typeof deployment_service_pb.GetZoneRequest;
  readonly responseType: typeof deployment_service_pb.GetZoneResponse;
};
...
type DeploymentApiGetPositioningReferent = {
  readonly methodName: string;
  readonly service: typeof DeploymentApi;
  readonly requestStream: false;
  readonly responseStream: false;
  readonly requestType: typeof deployment_service_pb.GetPositioningReferentRequest;
  readonly responseType: typeof deployment_service_pb.GetPositioningReferentResponse;
};
...
export class DeploymentApi {
  ...
  static readonly GetZone: DeploymentApiGetZone;
  ...
  static readonly GetPositioningReferent: DeploymentApiGetPositioningReferent;
...
export class DeploymentApiClient {
  ...
  getZone(
    requestMessage: deployment_service_pb.GetZoneRequest,
    metadata: grpc.Metadata,
    callback: (error: ServiceError|null, responseMessage: deployment_service_pb.GetZoneResponse|null) => void
  ): UnaryResponse;
  getZone(
    requestMessage: deployment_service_pb.GetZoneRequest,
    callback: (error: ServiceError|null, responseMessage: deployment_service_pb.GetZoneResponse|null) => void
  ...
  getPositioningReferent(
    requestMessage: deployment_service_pb.GetPositioningReferentRequest,
    metadata: grpc.Metadata,
    callback: (error: ServiceError|null, responseMessage: deployment_service_pb.GetPositioningReferentResponse|null) => void
  ): UnaryResponse;
  getPositioningReferent(
    requestMessage: deployment_service_pb.GetPositioningReferentRequest,
    callback: (error: ServiceError|null, responseMessage: deployment_service_pb.GetPositioningReferentResponse|null) => void
