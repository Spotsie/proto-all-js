...
export class MultilaterationConfig extends jspb.Message {
  getLpcCoefficient(): number;
  setLpcCoefficient(value: number): void;

  serializeBinary(): Uint8Array;
  toObject(includeInstance?: boolean): MultilaterationConfig.AsObject;
  static toObject(includeInstance: boolean, msg: MultilaterationConfig): MultilaterationConfig.AsObject;
  static extensions: {[key: number]: jspb.ExtensionFieldInfo<jspb.Message>};
  static extensionsBinary: {[key: number]: jspb.ExtensionFieldBinaryInfo<jspb.Message>};
  static serializeBinaryToWriter(message: MultilaterationConfig, writer: jspb.BinaryWriter): void;
  static deserializeBinary(bytes: Uint8Array): MultilaterationConfig;
  static deserializeBinaryFromReader(message: MultilaterationConfig, reader: jspb.BinaryReader): MultilaterationConfig;
}

export namespace MultilaterationConfig {
  export type AsObject = {
    lpcCoefficient: number,
  }
}

export class PointConfig extends jspb.Message {
  getRssiThreshold(): number;
  setRssiThreshold(value: number): void;

  serializeBinary(): Uint8Array;
  toObject(includeInstance?: boolean): PointConfig.AsObject;
  static toObject(includeInstance: boolean, msg: PointConfig): PointConfig.AsObject;
  static extensions: {[key: number]: jspb.ExtensionFieldInfo<jspb.Message>};
  static extensionsBinary: {[key: number]: jspb.ExtensionFieldBinaryInfo<jspb.Message>};
  static serializeBinaryToWriter(message: PointConfig, writer: jspb.BinaryWriter): void;
  static deserializeBinary(bytes: Uint8Array): PointConfig;
  static deserializeBinaryFromReader(message: PointConfig, reader: jspb.BinaryReader): PointConfig;
}

export namespace PointConfig {
  export type AsObject = {
...
export class Deployment extends jspb.Message {
  ...
  getMultilateration(): MultilaterationConfig | undefined;
  setMultilateration(value?: MultilaterationConfig): void;

  hasPoint(): boolean;
  clearPoint(): void;
  getPoint(): PointConfig | undefined;
  setPoint(value?: PointConfig): void;

  getLocatorConfigCase(): Deployment.LocatorConfigCase;
  serializeBinary(): Uint8Array;
...
export namespace Deployment {
  export type AsObject = {
    ...
    multilateration?: MultilaterationConfig.AsObject,
    point?: PointConfig.AsObject,
  }
