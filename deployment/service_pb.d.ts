...
export class GetZoneResponse extends jspb.Message {
  hasZone(): boolean;
  clearZone(): void;
  getZone(): deployment_organization_pb.Zone | undefined;
  setZone(value?: deployment_organization_pb.Zone): void;
...
export namespace GetZoneResponse {
  export type AsObject = {
    zone?: deployment_organization_pb.Zone.AsObject,
  }
}
...
export class UpdateDeploymentRequest extends jspb.Message {
  ...
  getMultilateration(): deployment_organization_pb.MultilaterationConfig | undefined;
  setMultilateration(value?: deployment_organization_pb.MultilaterationConfig): void;

  hasPoint(): boolean;
  clearPoint(): void;
  getPoint(): deployment_organization_pb.PointConfig | undefined;
  setPoint(value?: deployment_organization_pb.PointConfig): void;

  getLocatorConfigCase(): UpdateDeploymentRequest.LocatorConfigCase;
  serializeBinary(): Uint8Array;
...
export namespace UpdateDeploymentRequest {
  export type AsObject = {
    ...
    description: string,
    multilateration?: deployment_organization_pb.MultilaterationConfig.AsObject,
    point?: deployment_organization_pb.PointConfig.AsObject,
  }

  export enum LocatorConfigCase {
...
export class CreateDeploymentRequest extends jspb.Message {
  ...
  getLocatorConfigCase(): CreateDeploymentRequest.LocatorConfigCase;
  serializeBinary(): Uint8Array;
...
export class GetPositioningReferentRequest extends jspb.Message {
  getReferentId(): number;
  setReferentId(value: number): void;

  serializeBinary(): Uint8Array;
  toObject(includeInstance?: boolean): GetPositioningReferentRequest.AsObject;
  static toObject(includeInstance: boolean, msg: GetPositioningReferentRequest): GetPositioningReferentRequest.AsObject;
  static extensions: {[key: number]: jspb.ExtensionFieldInfo<jspb.Message>};
  static extensionsBinary: {[key: number]: jspb.ExtensionFieldBinaryInfo<jspb.Message>};
  static serializeBinaryToWriter(message: GetPositioningReferentRequest, writer: jspb.BinaryWriter): void;
  static deserializeBinary(bytes: Uint8Array): GetPositioningReferentRequest;
  static deserializeBinaryFromReader(message: GetPositioningReferentRequest, reader: jspb.BinaryReader): GetPositioningReferentRequest;
}

export namespace GetPositioningReferentRequest {
  export type AsObject = {
    referentId: number,
  }
}

export class GetPositioningReferentResponse extends jspb.Message {
  hasPositioningReferent(): boolean;
  clearPositioningReferent(): void;
  getPositioningReferent(): deployment_organization_pb.PositioningReferent | undefined;
  setPositioningReferent(value?: deployment_organization_pb.PositioningReferent): void;

  serializeBinary(): Uint8Array;
  toObject(includeInstance?: boolean): GetPositioningReferentResponse.AsObject;
  static toObject(includeInstance: boolean, msg: GetPositioningReferentResponse): GetPositioningReferentResponse.AsObject;
  static extensions: {[key: number]: jspb.ExtensionFieldInfo<jspb.Message>};
  static extensionsBinary: {[key: number]: jspb.ExtensionFieldBinaryInfo<jspb.Message>};
  static serializeBinaryToWriter(message: GetPositioningReferentResponse, writer: jspb.BinaryWriter): void;
  static deserializeBinary(bytes: Uint8Array): GetPositioningReferentResponse;
  static deserializeBinaryFromReader(message: GetPositioningReferentResponse, reader: jspb.BinaryReader): GetPositioningReferentResponse;
}

export namespace GetPositioningReferentResponse {
  export type AsObject = {
    positioningReferent?: deployment_organization_pb.PositioningReferent.AsObject,
  }
}
